...
class ContactDataView : UIViewController {
    ...
    let phoneLabel = ContactTitleLabel(labelTitle: NSLocalizedString("Phone", comment: ""))
    let emialLabel = ContactTitleLabel(labelTitle: NSLocalizedString("Email", comment: ""))
