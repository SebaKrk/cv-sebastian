...
class SkillsAndCoursesDataService {
    ...
    func setSkillsAndCoursesData() -> [Courses] {
        ...
        let sixthCourse = Courses(title: "Programming in PHP from scratch - theory and practice", author: "Tomasz Tomczyk", courseImg: "https://img-c.udemycdn.com/course/240x135/2885672_2a55_7.jpg", type: "PHP", skills: Skills(
            first: "Basic PHP syntax", second: "Basics of the MySQL database", third: "Good programming practices"))
        ...
        let seventhCourse = Courses(title: "iOS Dev Launchpad - iOS 15", author: "Sean Allen", courseImg: "https://www.filepicker.io/api/file/8NXzNENXQqqSoiiWiYSs", type: "Swift", skills: Skills(
            first: "Intro to the Swift Prog. Language", second: "Learn Xcode", third: "Storyboard & Programmatic UI"))
