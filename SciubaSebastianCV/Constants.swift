...
enum Constants {
    ...
    static let firstName  = "Sebastin"
    static let lastName  = "Ściuba"
    static let emailAdres = "s.sciuba@icloud.com"
    static let phoneNummber = 533611188
